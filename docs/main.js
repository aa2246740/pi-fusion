(() => {
  ...
  const i18n = {
    en: {
      metaTitle: "Pi Fusion - Model fusion for Pi agents",
      metaDescription: "Pi Fusion turns one prompt into independent model agents, judge synthesis, verification, and local artifacts inside Pi.",
      ...
      navGithub: "GitHub",
      languageToggle: "中文",
      heroEyebrow: "Model fusion for Pi agents",
      heroHeadline: "One prompt. A panel of models. One answer you can trust.",
      heroLede: "Pi Fusion turns a single high-stakes prompt into independent model answers, surfaces contradictions instead of hiding them, and lets a judge model synthesize, verify, and report the final answer - right inside Pi.",
      installCta: "Install Pi Fusion",
      workflowCta: "See the workflow",
      githubCta: "Open GitHub",
      installLabel: "Install",
      copy: "Copy",
      trustRow: "You choose the models · Optional evidence tools · Local artifacts and cost reporting",
      judge: "Judge",
      artifactText: "Consensus + caveats",
      ...
      workflowHeading: "From prompt to verified artifact.",
      workflowIntro: "The panel fans out, evidence is attached when available, and the judge turns disagreement into a stronger answer.",
      ...
      benchHeading: "Pi Fusion exceeds the Fusion API budget baseline.",
      benchIntro: "Pi Fusion is not just a demo of multi-model prompting. We tested it on the same DRACO 10-case benchmark protocol used to evaluate Fusion API budget mode. Pi Fusion exceeded the 64.70 Fusion API budget baseline, reaching 66.40 in full validation and 66.20 in the latest repeat validation, with all 10 cases completed and no judge failures.",
      metricPeak: "Best validation",
      metricDelta: "Delta vs budget",
      metricFailures: "Judge failures",
      tableSystem: "System / run",
      tableDelta: "Delta vs Fusion API budget",
      rowBudget: "Fusion API budget baseline",
      rowKept: "Pi Fusion kept validation",
      rowBest: "Pi Fusion best validation",
      rowLatest: "Pi Fusion latest validation",
      benchFootnote: "Generation used sanitized prompt-only case files. The benchmark answer/rubric/scoring artifacts were not available to Pi Fusion during generation and were used only after generation by the scorer.",
      safetyEyebrow: "Safety & control",
      safetyHeading: "Powerful tools, kept on a short leash.",
      safetyIntro: "No multi-agent writes to your real workspace. Evidence and artifacts are explicit, reviewable, and local.",
      safe1Title: "Sandboxed bash",
      safe1Copy: "Deterministic calculations run in a sandboxed environment.",
      safe2Title: "Read-only local context",
      safe2Copy: "Imported files are explicit evidence, not hidden state.",
      ...
      footerTagline: "Model fusion for Pi agents.",
    ...
    zh: {
      metaTitle: "Pi Fusion - 给 Pi agents 用的模型融合",
      metaDescription: "Pi Fusion 把一个提示变成独立模型小组、裁判综合、验证流程和 Pi 本地 artifact。",
      skip: "跳到正文",
      toggleNav: "切换导航",
      navOverview: "概览",
      navFeatures: "能力",
      ...
      heroEyebrow: "给 Pi agents 用的模型融合",
      heroHeadline: "一个问题，多模型小组，一个更可信的答案。",
      heroLede: "Pi Fusion 会把高风险问题分发给独立模型，让分歧显性化，再由裁判模型综合、验证并产出最终答案，全流程就在 Pi 里完成。",
      installCta: "安装 Pi Fusion",
      workflowCta: "查看流程",
      githubCta: "打开 GitHub",
      installLabel: "安装",
      copy: "复制",
      trustRow: "你选择模型 · 可选 evidence 工具 · 本地 artifact 和成本报告",
      judge: "裁判",
      artifactText: "共识 + 限制",
      ...
      workflowEyebrow: "流程",
      workflowHeading: "从 prompt 到可验证 artifact。",
      workflowIntro: "问题分发给模型小组，必要时附上 evidence，裁判把分歧整理成更强的答案。",
      ...
      benchHeading: "Pi Fusion 超过 Fusion API budget baseline。",
      benchIntro: "Pi Fusion 不只是 multi-model prompting 的 demo。我们在同一个用于评估 Fusion API budget mode 的 DRACO 10-case benchmark protocol 上测试了它。Pi Fusion 超过 64.70 的 Fusion API budget baseline，full validation 达到 66.40，latest repeat validation 达到 66.20，10 个 case 全部完成且没有 judge failure。",
      metricPeak: "最佳 validation",
      metricDelta: "相对 budget 差值",
      metricFailures: "Judge failures",
      tableSystem: "系统 / 运行",
      tableDelta: "相对 Fusion API budget",
      rowBudget: "Fusion API budget baseline",
      rowKept: "Pi Fusion kept validation",
      rowBest: "Pi Fusion best validation",
      rowLatest: "Pi Fusion latest validation",
      benchFootnote: "生成阶段只使用经过清理的 prompt-only case files。Benchmark answer/rubric/scoring artifacts 在生成阶段不提供给 Pi Fusion，只在生成后由 scorer 使用。",
      safetyEyebrow: "安全与控制",
      safetyHeading: "强工具，但边界明确。",
      safetyIntro: "不会让多 agent 直接写入真实 workspace。Evidence 和 artifacts 都是显式、可审查、本地保存的。",
      safe1Title: "Sandboxed bash",
      safe1Copy: "确定性计算在 sandbox 环境中运行。",
      safe2Title: "只读本地上下文",
      safe2Copy: "导入文件会作为显式 evidence，而不是隐藏状态。",
      safe3Title: "可选后端",
      ...
      footerTagline: "给 Pi agents 用的模型融合。",
      footerProduct: "产品",
      footerResources: "资源",
      footerProject: "项目",
